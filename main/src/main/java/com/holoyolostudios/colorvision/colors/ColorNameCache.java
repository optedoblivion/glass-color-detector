package com.holoyolostudios.colorvision.colors;
...
public class ColorNameCache {
    ...
    /**
     * Create a new instance of {@link com.holoyolostudios.colorvision.colors.ColorNameCache}.<br/>
     * Throws an {@link java.lang.IllegalStateException} if an instance has already been initialized.
     *
     * @return {@link com.holoyolostudios.colorvision.colors.ColorNameCache}
     */
    ...
    /**
     * Get an existing {@link com.holoyolostudios.colorvision.colors.ColorNameCache} instance.
    ...
    /**
     * Destroy the {@link com.holoyolostudios.colorvision.colors.ColorNameCache} instance
     */
    public void destroy() {
        mInitialized = false;
        mInstance = null;
    ...
    /**
     * Check whether or not the {@link com.holoyolostudios.colorvision.colors.ColorNameCache} instance
